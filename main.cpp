...
int main(int argc, char **argv)
{
    ...
    for (uint32_t i = 0; i < numVertices; ++i) {
        ...
        //doing perpsective prjecton using the x and z co-ordinates
        projectedVert.x= vertCamera.x/vertCamera.z;
        projectedVert.y= vertCamera.y/vertCamera.z;
        //dividing by -ve as z is in -ve value in the direction of projection of points
        projectedVert.x=-(projectedVert.x);
        projectedVert.y= -(projectedVert.y);
